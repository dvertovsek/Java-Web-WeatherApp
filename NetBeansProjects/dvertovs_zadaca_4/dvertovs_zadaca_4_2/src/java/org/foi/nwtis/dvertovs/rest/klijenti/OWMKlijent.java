 ...
 */
package org.foi.nwtis.dvertovs.rest.klijenti;
...
public class OWMKlijent {
    ...
    public List<MeteoPrognoza> getWeatherForecast(String latitude, String longitude) {
        WebTarget webResource = client.target(OWMRESTHelper.getOWM_BASE_URI())
        ...
        List<MeteoPrognoza> meteoPodaciLista = new ArrayList<>();
