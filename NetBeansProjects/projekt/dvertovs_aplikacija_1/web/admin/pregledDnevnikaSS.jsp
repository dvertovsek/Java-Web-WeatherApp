...
<html>
    <head>
        ...
        <title>Dnevnik SS</title>
    </head>
    <body>
        <h1>Korisnici</h1>
        <form action="${pageContext.servletContext.contextPath}/PregledDnevnikaSS">
            ...
            <sql:query var="rezultat">
                <%
                    ...
                    if (request.getParameter("kor") != null) {
                        filter = true;
                        filterString += " username LIKE '%" + request.getParameter("kor") + "%' ";
                    }
                ...
                %>
                select username, vrsta, naziv, vrijeme from dvertovs_dnevnik_WS join dvertovs_users USING(iduser) WHERE (vrsta = 'SS') <%= filterString%>    
            </sql:query>
            <%
